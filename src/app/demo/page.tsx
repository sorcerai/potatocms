    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="text-center space-y-6 mb-16">
          <Badge variant="secondary" className="text-sm px-4 py-2 bg-orange-50 text-orange-600 border border-orange-200">
            🚀 Live Demo
          </Badge>
          <h1 className="text-5xl font-bold tracking-tight text-gray-900">
            Experience <span className="bg-gradient-to-r from-orange-500 to-red-500 bg-clip-text text-transparent">PotatoCMS</span> in Action
          </h1>
        ...
        <div className="space-y-16">
          ...
          <section>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <Card className="border-green-200 bg-green-50">
                <CardHeader>
                  <div className="flex justify-between items-start">
                    <CardTitle className="text-lg text-green-800">Getting Started Guide</CardTitle>
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between items-center">
                      <span className="text-xs text-green-500">5 min read</span>
                      <Button size="sm" variant="outline" className="border-green-300 hover:bg-green-100">Read More</Button>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border-orange-200 bg-orange-50">
                <CardHeader>
                  <div className="flex justify-between items-start">
                    <CardTitle className="text-lg text-orange-800">Advanced Subscription Flows</CardTitle>
              ...
              <Card className="border-blue-200 bg-blue-50">
                <CardHeader>
                  <div className="flex justify-between items-start">
                    <CardTitle className="text-lg text-blue-800">API Integration Tutorial</CardTitle>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="bg-blue-100 p-3 rounded border border-blue-300">
                      <div className="flex items-center justify-between text-sm">
                        <span className="text-blue-700">Preview (2 of 8 sections)</span>
                        <Button size="sm" variant="outline" className="border-blue-300 hover:bg-blue-100">Continue Reading</Button>
                      </div>
                    </div>
                  </div>
                </CardContent>
          ...
          <section>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <Card className="border-orange-500 border-2 relative bg-white">
      ...
      <footer className="container mx-auto px-4 py-8 mt-16 border-t border-gray-200 bg-gray-50">
        <div className="text-center text-gray-600">
          <p>Built with 🥔 by <a href="https://www.linkedin.com/in/ariapramesi/" target="_blank" rel="noopener noreferrer" className="hover:text-orange-500 transition-colors font-semibold text-orange-500">Aria P</a> | <Link href="/" className="hover:text-orange-500 transition-colors">Back to Home</Link></p>
        </div>
      </footer>
    </div>
  )
